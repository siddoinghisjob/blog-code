    ...
    <PageTransition>
      <main class="flex flex-col p-4 px-5 md:p-8">
        <article class="flex-1 flex flex-col h-full">
          <header class="mb-6">
            <h1 class="text-3xl font-bold mb-2">Why do we even need qwik JS?</h1>
            <div class="flex flex-wrap gap-x-3 gap-y-1 items-center">
              <span class="text-sm text-gray-600">By Soumya Deep Sarkar</span>
              <span class="text-sm text-gray-600">•</span>
              <time class="text-sm text-gray-600" dateTime="2025-06-08">2025-06-08</time>
            </div>
          </header>
...
export const head: DocumentHead = {
  title: "Why do we even need qwik JS? | Soumya Deep Sarkar", // Adjust site name
  meta: [
    ...
    { property: "og:title", content: "Why do we even need qwik JS?" },
    ...
    { name: "twitter:title", content: "Why do we even need qwik JS?" },
    ...
    { name: "twitter:image", content: "https://res.cloudinary.com/db5l3d16l/image/upload/v1749381088/portfolio-blog-images/blog-why-do-we-even-need-qwik-js.png" },
